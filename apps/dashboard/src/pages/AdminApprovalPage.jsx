...
function PendingUsersTable({ users, approving, onApprove, formatDate }) {
  return (
    <div
    ...
    >
      ...
      {users.map((user, index) => (
        <div
          key={user.id}
          className="grid grid-cols-12 gap-6 px-6 py-5 transition-all duration-200 items-center hover:bg-[var(--bg-header)]"
          style={{
            borderBottom:
        ...
        >
          ...
          <div className="col-span-3 text-right flex justify-end">
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-2.5 rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed text-sm font-semibold hover:shadow-md hover:-translate-y-[1px] hover:bg-[var(--primary-dark)] hover:border-[var(--primary-dark)]"
              style={{
